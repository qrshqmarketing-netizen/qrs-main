...
import { cardFor, COMMERCIAL, EMERGENCY, FINANCING, GUTTERS, HOA, SECTIONS, sectionPages as pagesOf, SERVICE_HUB_PAGES, serviceHref } from '@/data/content';
...
export const PAGE_INDEX = [
  ...
  ...[EMERGENCY, FINANCING].map((p) => servicePage(p.href, p.page, 'services', '/')),
  {
    ...
    paragraphs: [CARE_PLAN.scope.intro],
    lists: [
