...
export function QrsMark({ fill = '#062d57', stroke = '#d4b572' }) {
  return (
    <>
...
// Phone handset (the red "call now" buttons)
export function PhoneIcon({ strokeWidth = 2, ...props }) {
  return (
    <svg {...lineIcon} strokeWidth={strokeWidth} {...props}>
      <path d="M21 16.9v3a2 2 0 0 1-2.2 2 19.8 19.8 0 0 1-8.6-3.1 19.5 19.5 0 0 1-6-6A19.8 19.8 0 0 1 1.1 4.2 2 2 0 0 1 3.1 2h3a2 2 0 0 1 2 1.7c.1.9.4 1.8.7 2.7a2 2 0 0 1-.5 2.1L7.1 9.8a16 16 0 0 0 6 6l1.3-1.3a2 2 0 0 1 2.1-.4c.9.3 1.8.6 2.7.7a2 2 0 0 1 1.8 2Z" />
    </svg>
  );
}
...
// Restart / "new chat" icon (two curved arrows)
export function RefreshIcon({ strokeWidth = 2.2, ...props }) {
  return (
    <svg {...lineIcon} strokeWidth={strokeWidth} {...props}>
