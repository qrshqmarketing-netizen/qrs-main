...
const ABOUT = [
  'At Quality Roofing Specialists, we believe roofing should be detail-first. With 30+ years of roofing experience, our crews bring the same care to every [roof replacement](/residential-roofing/#roof-replacement), roof repair, [tile lift & relay](/tile-roofing/lift-and-relay/) and [flat](/flat-roofing/) or [shingle roof](/shingle-roofing/) — with clear scopes, no pressure and no mystery pricing.',
  'Before any work starts, you get a written scope and price. We document what we find with photos, explain it in plain English and back our installs with a lifetime workmanship warranty. Straightforward, honest work from a local roofing team across [Southern California](/locations/).',
