  ...
  return (
    <section className="hero hero-photo" aria-label="QRS Los Angeles roofing">
      <div className="hero-roof-texture" aria-hidden="true">
        <Image src="/images/home-hero-drone-view.webp" alt="" fill preload sizes="100vw" />
      </div>
      ...
      <div className="container hero-inner">
        <div className="hero-copy">
          ...
          <p className="hero-sub">Clear inspections. Straightforward estimates. Clean workmanship.</p>
          <div className="hero-actions">
            <a className="btn btn-gold" href="#roof-check">
